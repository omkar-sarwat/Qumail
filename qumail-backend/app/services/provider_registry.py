...
PROVIDERS: List[ProviderSettings] = [
    ...
    ProviderSettings(
        ...
        imap_port=995,
        imap_security="ssl",
        notes="Uses POP3 (not IMAP). Enable SSL for secure connection. Use full email as username.",
    ),
    ProviderSettings(
        name="Rediffmail Pro",
        domains=["rediffmailpro.com"],
        smtp_host="smtp.rediffmailpro.com",
        smtp_port=587,
        smtp_security="starttls",
        imap_host="pop.rediffmailpro.com",
        imap_port=995,
        imap_security="ssl",
        notes="Uses POP3 (not IMAP). Pro account with SSL. Use full email as username.",
    ),
    ProviderSettings(
        name="Zoho",
        domains=["zoho.com"],
