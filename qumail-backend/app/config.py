...
class Settings(BaseSettings):
    ...
    secret_key: str = Field(default="IkXXta6Dy6vBM46Zg_o6BanqaahWjPZjmUBCqVocUsE", alias="SECRET_KEY")
    access_token_expire_minutes: int = Field(default=60, alias="ACCESS_TOKEN_EXPIRE_MINUTES")
    encryption_master_key: str = Field(default="PhTmY1UfJ-VbTWMdaWnR67_rIPSiJ_YS-avzTD0Xogk=", alias="ENCRYPTION_MASTER_KEY", description="Base64 fernet key")
    ...
    km1_client_cert_pfx: str = Field(default="", alias="KM1_CLIENT_CERT_PFX")
    km2_client_cert_pfx: str = Field(default="", alias="KM2_CLIENT_CERT_PFX")
    ...
    km1_ca_cert: str = Field(default="", alias="KM1_CA_CERT")
    km2_ca_cert: str = Field(default="", alias="KM2_CA_CERT")
    sender_sae_id: int = Field(default=1, alias="SENDER_SAE_ID")
    receiver_sae_id: int = Field(default=2, alias="RECEIVER_SAE_ID")
    ...
    allowed_origins: str = Field(
        default="http://localhost:3000,http://localhost:5173,https://temp2mgm.netlify.app,https://qumail-rho.vercel.app,https://qumail-frontend.vercel.app,https://qumail-frontend.netlify.app", 
