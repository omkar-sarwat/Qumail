...
let kme1Process = null;
let kme2Process = null;
...
async function startKMEServers() {
...
app.whenReady().then(async () => {
    try {
        ...
        dialog.showErrorBox('Startup Error', 'Failed to start QuMail backend services. Please check the logs and try again.');
        app.quit();
    }
});
