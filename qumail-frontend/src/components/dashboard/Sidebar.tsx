    ...
    <div className="h-full flex flex-col bg-white dark:bg-[#161b22] rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden">
        ...
        <nav className="space-y-0.5">
          {folders.map((folder) => (
            <button
              ...
              className={`group w-full flex items-center justify-between px-3 py-2 rounded-md text-left transition-colors duration-150 ${
            ...
            >
              <div className="flex items-center gap-2.5">
                <div className={`w-4 h-4 flex items-center justify-center ${
                  activeFolder === folder.id ? 'text-blue-600 dark:text-blue-400' : 'text-gray-500 dark:text-gray-400'
                }`}>
                  {folder.icon}
                </div>
      ...
      <div className="mt-auto w-full">
        <div className="px-2 py-3 border-t border-gray-100 dark:border-gray-800">
          ...
          <nav>
            <button
              onClick={() => onNavigateToView && onNavigateToView('quantum')}
              className="group w-full flex items-center justify-between px-3 py-2 rounded-md text-left transition-colors duration-150 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800/50"
            >
              <div className="flex items-center gap-2.5">
                <div className="w-4 h-4 flex items-center justify-center text-purple-600 dark:text-purple-400">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                </div>
                <span className="font-medium text-sm">Quantum Dashboard</span>
              </div>
        ...
        {/* ETSI Compliance Badge */}
        <div className="p-3 pt-0">
          <div className="bg-blue-50 dark:bg-blue-900/10 rounded-md p-2 text-center border border-blue-200 dark:border-blue-800/30">
